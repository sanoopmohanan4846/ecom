...
from paymentapp.forms import ShippingForm, PaymentForm
from paymentapp.models import ShippingAddress, Order, OrderItem
...
def process_order(request):
    if request.POST:
        ...
        # get all the billing info 
        payment_form = PaymentForm(request.POST or None)
        # get shipping sessions data
